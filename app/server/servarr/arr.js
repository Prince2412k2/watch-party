...
// server-side instead, so the client is only ever handed a same-origin path. A
// fixed host allow-list keeps the proxy from becoming an open (SSRF-able) one;
// see remoteImageFetch for the rest of the hardening.
