...
/** A horizontally scrolling strip of choices. Every picker in here is one of
    these, so a slot with 43 parts and a slot with 3 behave the same, and both
    stay inside the viewport on a phone. */
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Live preview + the one text field */}
        <div style={{ display: 'flex', gap: 18, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          />
          <div style={{ flex: '1 1 220px', minWidth: 0, display: 'flex', flexDirection: 'column', gap: 7 }}>
            <label htmlFor="display-name" style={{ fontSize: 11, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--text3)' }}>
              Display name
            </label>
            <input
              id="display-name"
              ...
              style={{
                ...
                fontSize: 14, fontFamily: 'inherit', minWidth: 0,
              }}
            />
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                {swatches.map(hex => (
                  <button
                    ...
                    style={{
                      width: 36, height: 36, borderRadius: 999, cursor: 'pointer', padding: 0,
                      background: `#${hex}`,
