...
function Poster({ images, alt, style, useBackdrop }) {
...
function SeasonChooser({ item, mobile, onWholeSeriesFallback }) {
...
function ReleasePicker({ item, onClose, onGrabbed }) {
  const mobile = useIsMobile()
  const [meta, setMeta] = useState({ loading: true, error: '' })
...
function ResultsSkeleton({ mobile }) {
  return (
