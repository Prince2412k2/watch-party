...
import { useHideSelf } from '../hooks/useHideSelf.js'
...
function MobileCameraStrip({ localParticipant, participants, isHost, removedCameras, onRemove, hideSelf, visible }) {
...
function LobbyAVBar({ lk, chatOpen, onToggleChat, hideSelf, onToggleHideSelf }) {
  const Btn = ({ on, danger, onClick, title, children }) => (
