...
export function Icon({ path, size = 20, stroke = 'currentColor', fill = 'none', sw = 1.7, style }) {
  return (
...
export function TopBar({ mobile, initials, logout, title, detail, onBack }) {
  return (
    <div style={{
...
export function Spinner({ size = 20, dark }) {
  return (
