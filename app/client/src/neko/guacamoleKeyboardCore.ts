// @ts-nocheck
/* eslint-disable */
// Ported verbatim from neko/client/src/utils/guacamole-keyboard.js (Apache-2.0
// licensed Guacamole JS keyboard). Kept as untyped JS-in-TS on purpose — this
// is vendored code, not ours to restyle. See guacamoleKeyboard.ts for the
// typed wrapper used by the rest of the app.
