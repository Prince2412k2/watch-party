...
import { C, SANS, Icon, Ic, Spinner } from '../../lib/ui.jsx'
import { IS_NATIVE } from '../env.js'
import { useDownloads, useOfflineLibrary } from '../useOffline.js'
import { formatBytes, progressPct } from './format.js'

export default function DownloadButton({ itemId, title, url, parts }) {
