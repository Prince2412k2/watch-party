...
import { C, SANS, MONO, Icon, Ic } from '../../lib/ui.jsx'
import { formatBytes, formatSpeed, progressPct } from './format.js'
...
export default function DownloadProgress({ record, onPause, onResume, onCancel }) {
