 ...
 */
export function Img({ id, type = 'Primary', fallback, style, alt = '', className }) {
 ...
 */
export function Poster({ id, type = 'Primary', fallback, title = '', w, ratio = '2 / 3', radius = R.md, onClick, style, children }) {
