 ...
 */
export function Skeleton({ w = '100%', h = 14, radius = R.sm, style }: any = {}) {
  return (
    <span
      aria-hidden="true"
      style={{
...
export function PosterSkeleton({ w, ratio = '2 / 3', radius = R.md }: any = {}) {
  return <Skeleton w={w} h="auto" radius={radius} style={{ aspectRatio: ratio }} />
}

// A horizontal row of poster skeletons for a loading rail.
export function RailSkeleton({ count = 4, w = 118, gap = 14, padX = 16 }: any = {}) {
  return (
