...
import { Rail, RailItem } from '../ui/Rail.jsx'
import { Sheet } from '../ui/Sheet.jsx'
import { Skeleton, RailSkeleton } from '../ui/Skeleton.jsx'
...
function PosterCard({ item, onOpen, badge }) {
  return (
...
function StillCard({ item, onOpen, progress }) {
...
function DownloadingCard({ torrent }) {
...
function DetailHero({ item, onWatch }) {
...
function EpisodeRow({ ep, onWatch }) {
